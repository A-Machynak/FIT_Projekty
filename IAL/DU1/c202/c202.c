...
int Stack_IsEmpty( const Stack *stack ) {
	...
	// "Funkci implementujte jako jediný příkaz", ale pro úplnost 
	// jsem přidal kontrolu nullptr
...
void Stack_Pop( Stack *stack ) {
	...
	// Sniž počet položek v zásobníku
	stack->topIndex--;
}
...
void Stack_Push( Stack *stack, char data ) {
	...
	// Inkrementuje počet položek na stacku a vlož na tuto pozici znak
